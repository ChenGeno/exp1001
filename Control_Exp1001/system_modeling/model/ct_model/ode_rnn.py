...
from ..func import zeros_like_with_shape, normal_differential_sample
from .. import BaseModel


class ODE_RNN(nn.Module, BaseModel):
    ...
    def call_loss(self, external_input_seq, observations_seq, memory_state=None):
        ...
        outputs, memory_state = self.forward_prediction(future_input, memory_state=memory_state, grad=False)
