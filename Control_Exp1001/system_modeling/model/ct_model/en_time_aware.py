...
from ..common import logsigma2cov, split_first_dim, DBlock, DiagMultivariateNormal as MultivariateNormal
from ..func import normal_differential_sample
from .. import BaseModel


class TimeAwareRNN(nn.Module, BaseModel):
    ...
    def _forward_prediction(self, external_input_seq, n_traj=16, max_prob=False, memory_state=None):
    ...
    def call_loss(self, external_input_seq, observations_seq, memory_state=None):
        ...
        pred_outputs, memory_state = self.forward_prediction(future_input, n_traj=1, memory_state=memory_state, grad=True)
