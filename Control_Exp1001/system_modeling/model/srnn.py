...
from .common import (DBlock, PreProcess, MLP, logsigma2cov,
                     split_first_dim, DiagMultivariateNormal as MultivariateNormal)
from .func import normal_differential_sample, multivariate_normal_kl_loss
from . import BaseModel


class SRNN(nn.Module, BaseModel):
