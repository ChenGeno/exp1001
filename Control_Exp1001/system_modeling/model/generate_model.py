...
import torch
from . import VRNN, VAERNN, STORN, RNN, SRNN, ODERSSM, RSSM, TimeAwareRNN, DeepAR, STORN_SQRT, ODE_RNN, LatentSDE, NN, GunnarODE
...
def generate_model(args):
    ...
    elif args.model.type == 'gunnar_ode':
        assert args.ct_time
        model = GunnarODE(
            h_size=args.model.h_size,
            u_size=args.dataset.input_size,
